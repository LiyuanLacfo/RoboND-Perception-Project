...
# Exercise-3 TODOs: 
    ...
    for index, pts_list in enumerate(cluster_indices):
        ...
        normal_feature = compute_normal_histograms(ros_pts)
...
if __name__ == '__main__':
    ...
    model_items = pickle.load(open('model.sav', 'rb'))
    clf, classes, scaler = model_items['model'], model_items['classes'], model_items['scaler']
