...
training_set = pickle.load(open('training_set_200.sav', 'rb'))
...
print("training accuracy: {}, validation accuracy: {}".format(training_score, validation_score))
...
pickle.dump(model, open('model_200.sav', 'wb'))
print("Model saved")
